...
public class UnicornQuestService extends AbstractQuestService {
    ...
    public void initModel() {
        ...
        var step2 = new QuestStep("Ты отправляешься к Волшебному лесу. На опушке растет старое Мудрое дерево, " +
                "вмещающее всю мудрость Волшебного леса, " +
                "а в глубь леса уходят подозрительные следы. " +
        ...
        var step5 = new QuestStep("Ты обращаешься к Мудрому дереву, оно согласно помочь, но " +
                ...
                "На коре дерева появлется текст загадки " +
                "\"Без меня нет рассвета, без меня нет заката, вечно я живу\". Твой ответ:");

        var step17 = new QuestStep("Ты дал правильный ответ, " +
                "Мудрое дерево дает тебе ценные подсказки о местонахождении логова и слабых местах Злого колдуна. " +
        ...
        var step13 = new QuestStep("Ты находишь логово Злого колдуна, " +
                "побеждаешь его и освобождаешь Пследнего единорога, " +
        ...
        step2.getChoices().add(new QuestChoice("Идти по следам в глубь Волшебного леса.",
                step4));
